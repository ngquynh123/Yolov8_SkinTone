...
# ========== Cấu hình ========== #
SAMPLE_DIR = "public/skin tone values/Type_3"            # Thư mục chứa ảnh mẫu tone 3
INPUT_DIR = "public/dataset_14/dataset_cheeks_skin/Type_3"   # Ảnh đã gán nhãn là Type_3
OUTPUT_DIR = "public/dataset_14/type_3_filtered/Type_3"      # Thư mục lưu ảnh sau khi lọc
THRESHOLD = 23.5                                            # Ngưỡng độ chênh lệch màu
